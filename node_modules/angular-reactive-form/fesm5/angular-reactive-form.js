...
import { DraftJs } from '@lebaotrung/react_draft-js';
import { EditorModule } from '@tinymce/tinymce-angular';
import { NG_VALUE_ACCESSOR, FormsModule, ReactiveFormsModule, FormControl, FormGroup } from '@angular/forms';
import { isUndefined, isEmpty, map, forEach, find, remove, isEqual, assign, isNil, groupBy, head, includes } from 'lodash';
import { HttpClient } from '@angular/common/http';
import { map as map$1, catchError, tap } from 'rxjs/operators';
import { Component, Input, forwardRef, ElementRef, Renderer, ViewChild, Injector, ChangeDetectorRef, Injectable, NgModule } from '@angular/core';
import { __assign, __values, __awaiter, __generator, __extends } from 'tslib';
...
var CustomSelectionComponent = /** @class */ (function () {
    ...
    Object.defineProperty(CustomSelectionComponent.prototype, "value", {
         ...
         */
        function (val) {
            this.selected = find(this.options, (/**
             * @param {?} item
             * @return {?}
             */
...
var MutipleCheckboxComponent = /** @class */ (function () {
    ...
    function () {
        ...
        function () {
            if (_this.isClear === true) {
                if (!isUndefined(_this.options) && !isEmpty(_this.options)) {
                    map(_this.options, (/**
                     * @param {?} i
                     * @return {?}
                     */
    ...
    function () {
         ...
         */
        function () {
            if (_this.options !== null && _this.options !== undefined && !isEmpty(_this.options)) {
                /** @type {?} */
                var $this_1 = _this;
                forEach(_this.options, (/**
                 * @param {?} value
                 * @return {?}
                 */
                function (value) {
...
var CustomDropzoneComponent = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var $this = this;
        if (this.maxFiles !== 1 && !isEmpty($this.oldValue)) {
            forEach(this.oldValue, (/**
             * @param {?} value
             * @return {?}
             */
            function (value) {
...
var CustomSelect2Component = /** @class */ (function () {
    ...
    function () {
        var _this = this;
        if (this.isClear === true) {
            if (!isUndefined(this.options) && !isEmpty(this.options)) {
                map(this.options, (/**
                 * @param {?} i
                 * @return {?}
                 */
    ...
    function () {
        ...
        if (oldData != null && oldData !== undefined && !isEmpty(oldData)) {
            forEach(oldData, (/**
             * @param {?} value
             * @return {?}
             */
...
var CustomCheckboxComponent = /** @class */ (function () {
    ...
    /** @nocollapse */
    CustomCheckboxComponent.ctorParameters = function () { return [
        { type: ElementRef },
        { type: Renderer }
    ]; };
...
var FileService = /** @class */ (function () {
    ...
    function (params, apiUpload, headers) {
        ...
        return this.http.post(apiUpload, formData, { headers: headers }).pipe(map$1((/**
         * @param {?} response
         * @return {?}
         */
    ...
    function (params, apiUpload) {
        ...
        return this.http.post(apiUpload, formData).pipe(map$1((/**
         * @param {?} response
         * @return {?}
         */
        function (response) { return response; })));
...
var UploadImagesComponent = /** @class */ (function () {
    ...
    function () {
        ...
        if (this.isClear === true) {
             ...
             */
            function () {
                if (!isNil(_this.multiple) && _this.multiple === true) {
                    _this.oldValue = [];
                    _this.fileList = [];
                }
                else {
                ...
                /** @type {?} */
                var $this = _this;
                if (!isNil(_this.multiple) && _this.multiple === true && !isEmpty($this.oldValue)) {
                    forEach(_this.oldValue, (/**
                     * @param {?} value
                     * @return {?}
                     */
                    function (value) {
    ...
    function () {
        ...
        var $this = this;
        this.isload = true;
        if (!isNil(this.multiple) && this.multiple === true && !isEmpty($this.oldValue)) {
            forEach(this.oldValue, (/**
             * @param {?} value
             * @return {?}
             */
    ...
    function (file) {
        var _this = this;
        if (file !== undefined) {
            if (!isNil(this.allowMaxSize) && this.allowMaxSize !== '') {
            ...
            // tslint:disable-next-line:max-line-length
            if (!isUndefined(this.accept) &&
                isUndefined(find(this.valid_extensions, (/**
                 * @param {?} item
                 * @return {?}
                 */
    ...
    function (file) {
        ...
        function (response) {
            ...
            if (!isNil($this.multiple) && $this.multiple === true) {
...
var SelectionService = /** @class */ (function () {
    ...
    function (api, headers, method) {
        return this.http.request(method, api, { headers: headers }).pipe(map$1((/**
         * @param {?} response
         * @return {?}
         */
        function (response) {
...
var SelectionByApiComponent = /** @class */ (function () {
    ...
    function () {
        ...
        function (item, key) {
            ...
            if (isEqual(item, $this.value)) {
                assign(item, { selected: true });
            }
        }));
    };
    /**
    ...
    function (event) {
        ...
        if (event.keyCode === this.KEY_CODE.DOWN_ARROW && this.isShow) {
            ...
            if (this.value) {
                /** @type {?} */
                var current_item = find(this.options, (/**
                 * @param {?} i
                 * @return {?}
                 */
     ...
     */
    function (array) {
        return isEmpty(array) ? true : false;
    };
    /**
     * @param {?} item
     * @return {?}
...
var UploadFilesComponent = /** @class */ (function () {
    function UploadFilesComponent(injector, api, element, renderer, http, progress) {
        this.injector = injector;
        this.api = api;
        this.element = element;
        this.renderer = renderer;
...
var DraftJsComponent = /** @class */ (function () {
    ...
    function () {
        ...
        new DraftJs(this.el.nativeElement, options);
    };
    ...
    /** @nocollapse */
    DraftJsComponent.ctorParameters = function () { return [
        { type: ElementRef }
    ]; };
...
var ReactiveFormComponent = /** @class */ (function () {
    ...
    function (changes) {
        ...
        var groups = [];
        /** @type {?} */
        var grouped = groupBy(this.inputs, 'group');
        // tslint:disable-next-line:forin
        for (var k in grouped) {
            groups.push({
                group: k,
                items: grouped[k],
                classes: head(grouped[k]).group_classes
            });
        }
        this.groups = groups;
...
var DynamicInputComponent = /** @class */ (function () {
    ...
    function (validators) {
        ...
        function (value) {
            ...
            if (!isUndefined(errorValidator) && !isNil(errorValidator)) {
                /** @type {?} */
...
var AngularReactiveFormModule = /** @class */ (function () {
    ...
    /** @nocollapse */
    AngularReactiveFormModule.ctorParameters = function () { return [
        { type: Injector }
    ]; };
...
function (inputs, data, options) {
    ...
    function (value, key) {
        ...
        function (input) {
            if (input.key === key) {
                if (includes(ableSimpleValue, input.controlType)) {
                    input.value = value;
                    return input;
                }
...
function (inputs, data) {
    ...
    function (value, key) {
        ...
        function (input) {
            if (input.key === key) {
                if (includes(ableType, input.controlType)) {
                    input.options = value;
                }
                if (input.controlType === 'dropdown') {
                    input.value = head(value);
                }
                if (input.controlType === 'radio') {
                    input.value = head(value).value;
                }
            }
        }));
    }));
...
export { CustomDropdown, TextBox, DropZone, CheckBox, Dropdown, ListCheckBox, Radio, TextBoxMask, TinyMce, DateTimePicker, PhoneCode, Select2, InputBase, CustomCheckBox, TextArea, UploadFile, Province, SelectionByApi, Block, Captcha, UPLOAD_DIRECTIVE_HEADERS, UPLOAD_DIRECTIVE_API_URL, SingleSelect2, SwitchInput, UploadFileV2, AngularReactiveFormComponent, AngularReactiveFormModule, VALIDATOR_REQUIRED, VALIDATOR_PATTERN, VALIDATOR_MINLENGTH, VALIDATOR_MAXLENGTH, UpdateFormValue, UpdateInputsValue, support, DefaultValidators, DynamicInputComponent as ɵx, ReactiveFormComponent as ɵv, CaptchaComponent as ɵp, CustomCheckboxComponent as ɵi, CustomDateTimePickerComponent as ɵf, CustomSelect2Component as ɵh, CustomSelectionComponent as ɵb, CustomSwitchInputComponent as ɵr, DirectivesModule as ɵa, DraftJsComponent as ɵu, CustomDropzoneComponent as ɵe, MaskInputComponent as ɵc, MultiSelectionByApiComponent as ɵo, MutipleCheckboxComponent as ɵd, PhoneInputComponent as ɵg, ProvinceCityComponent as ɵl, SelectionService as ɵn, SelectionByApiComponent as ɵm, SingleSelect2Component as ɵq, FileService$1 as ɵt, UploadFilesComponent as ɵs, FileService as ɵk, UploadImagesComponent as ɵj, FormControlService as ɵw };

//# sourceMappingURL=angular-reactive-form.js.map