(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('@angular/common'), require('angular2-text-mask'), require('ngx-dropzone-wrapper'), require('primeng/calendar'), require('@ngx-progressbar/http'), require('@ngx-progressbar/core'), require('@lebaotrung/react_draft-js'), require('@tinymce/tinymce-angular'), require('@angular/forms'), require('lodash'), require('@angular/common/http'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-reactive-form', ['exports', '@angular/router', '@angular/common', 'angular2-text-mask', 'ngx-dropzone-wrapper', 'primeng/calendar', '@ngx-progressbar/http', '@ngx-progressbar/core', '@lebaotrung/react_draft-js', '@tinymce/tinymce-angular', '@angular/forms', 'lodash', '@angular/common/http', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['angular-reactive-form'] = {}),global.ng.router,global.ng.common,global.angular2TextMask,global.ngxDropzoneWrapper,global.calendar,global.http,global.core,global.react_draftJs,global.tinymceAngular,global.ng.forms,global._,global.ng.common.http,global.rxjs.operators,global.ng.core));
}(this, (function (exports,router,common,angular2TextMask,ngxDropzoneWrapper,calendar,http,core,react_draftJs,tinymceAngular,forms,_,http$1,operators,core$1) { 'use strict';

    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var AngularReactiveFormComponent = /** @class */ (function () {
        function AngularReactiveFormComponent() {
        }
        /**
         * @return {?}
         */
        AngularReactiveFormComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        AngularReactiveFormComponent.decorators = [
            { type: core$1.Component, args: [{
                        selector: 'arf-angular-reactive-form',
                        template: "\n    <p>\n      angular-reactive-form works!\n    </p>\n  "
                    }] }
        ];
        /** @nocollapse */
        AngularReactiveFormComponent.ctorParameters = function () { return []; };
        return AngularReactiveFormComponent;
    }());
    ...
    var CustomSelectionComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CustomSelectionComponent.ctorParameters = function () {
            return [
    ...
    var MaskInputComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MaskInputComponent.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
        ...
        MaskInputComponent.propDecorators = {
            inputMaskText: [{ type: core$1.Input }],
            guide: [{ type: core$1.Input }],
            _value: [{ type: core$1.Input }],
            valueWithCharacter: [{ type: core$1.Input }],
            placeholder: [{ type: core$1.Input }],
            isClear: [{ type: core$1.Input }],
            isDisabled: [{ type: core$1.Input }]
        };
    ...
    var MutipleCheckboxComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MutipleCheckboxComponent.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
    ...
    var CustomDropzoneComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CustomDropzoneComponent.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer },
        ...
        CustomDropzoneComponent.propDecorators = {
            ...
            upload_path: [{ type: core$1.Input }],
            acceptedFiles: [{ type: core$1.Input }],
            maxFilesize: [{ type: core$1.Input }],
            maxFiles: [{ type: core$1.Input }],
            showPreview: [{ type: core$1.Input }],
            oldValue: [{ type: core$1.Input }],
            url: [{ type: core$1.Input }],
            headers: [{ type: core$1.Input }],
            paramName: [{ type: core$1.Input }],
            _value: [{ type: core$1.Input }],
            resultTransformer: [{ type: core$1.Input }],
            componentRef: [{ type: core$1.ViewChild, args: [ngxDropzoneWrapper.DropzoneComponent,] }],
            directiveRef: [{ type: core$1.ViewChild, args: [ngxDropzoneWrapper.DropzoneDirective,] }]
        };
    ...
    var CustomDateTimePickerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CustomDateTimePickerComponent.ctorParameters = function () {
            return [
        ...
        CustomDateTimePickerComponent.propDecorators = {
            ...
            monthNavigator: [{ type: core$1.Input }],
            yearNavigator: [{ type: core$1.Input }],
            yearRange: [{ type: core$1.Input }],
            showTime: [{ type: core$1.Input }],
            timeOnly: [{ type: core$1.Input }],
            dateFormat: [{ type: core$1.Input }],
            isDisabled: [{ type: core$1.Input }],
    ...
    ***************************************************************************** */
    ...
    var PhoneInputComponent = /** @class */ (function () {
         ...
         */
            function (val) {
                val = val.split('-');
                this.phoneData = __assign({}, this.phoneData, { code: val[0], alpha2Code: val[1] });
            };
        /**
         * @param {?} val
         * @return {?}
         ...
         */
            function (val) {
                this.phoneData = __assign({}, this.phoneData, { value: val });
            };
        /**
         * @param {?} value
         * @return {?}
    ...
    var CustomSelect2Component = /** @class */ (function () {
        ...
        /** @nocollapse */
        CustomSelect2Component.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
        ...
        CustomSelect2Component.propDecorators = {
            ...
            _value: [{ type: core$1.Input }],
            isClear: [{ type: core$1.Input }],
            isSelectAll: [{ type: core$1.Input }],
            selectBtnText: [{ type: core$1.Input }],
            clearBtnText: [{ type: core$1.Input }],
            isDisabled: [{ type: core$1.Input }]
        };
    ...
    var CustomCheckboxComponent = /** @class */ (function () {
        function CustomCheckboxComponent(element, renderer) {
            this.element = element;
            this.renderer = renderer;
            this.onChang = ( /**
             * @param {?} val
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.writeValue = /**
         * @param {?} val
         * @return {?}
         */
            function (val) {
        ...
        Object.defineProperty(CustomCheckboxComponent.prototype, "value", {
            get: /**
             * @return {?}
             */ function () {
                return this._value;
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.registerOnChange = /**
         * @param {?} fn
         * @return {?}
         */
            function (fn) {
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.registerOnTouched = /**
         * @param {?} fn
         * @return {?}
         */
            function (fn) {
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.setDisabledState = /**
         * @param {?} isDisabled
         * @return {?}
         */
            function (isDisabled) {
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
                this.value = false;
         ...
         * @return {?}
         */
        CustomCheckboxComponent.prototype.onChangeFunction = /**
         * @return {?}
         */
            function () {
                this.onChange();
                        ...
                        providers: [
                            {
                                ...
                                useExisting: core$1.forwardRef(( /**
                                 * @return {?}
                                 */function () { return CustomCheckboxComponent; })),
                                multi: true
                            }
                        ],
                        styles: [""]
        ...
        /** @nocollapse */
        CustomCheckboxComponent.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
    ...
    var FileService = /** @class */ (function () {
         ...
         */
            function (params, apiUpload, headers) {
                ...
                return this.http.post(apiUpload, formData, { headers: headers }).pipe(operators.map(( /**
                 * @param {?} response
                 * @return {?}
         ...
         */
            function (params, apiUpload) {
                ...
                return this.http.post(apiUpload, formData).pipe(operators.map(( /**
                 * @param {?} response
                 * @return {?}
                 */function (response) { return response; })));
            };
    ...
    var UploadImagesComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        UploadImagesComponent.ctorParameters = function () {
            return [
                { type: core$1.Injector },
                { type: FileService },
                { type: core$1.ElementRef },
        ...
        UploadImagesComponent.propDecorators = {
            id: [{ type: core$1.Input }],
            headers: [{ type: core$1.Input }],
            apiUpload: [{ type: core$1.Input }],
            accept: [{ type: core$1.Input }],
            subProgress: [{ type: core$1.Input }],
            subError: [{ type: core$1.Input }],
            allowMaxSize: [{ type: core$1.Input }],
            uploadPath: [{ type: core$1.Input }],
    ...
    /** @type {?} */
    var Provinces = (( /** @type {?} */(Object))).values(json$1);

    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ProvinceCityComponent = /** @class */ (function () {
        function ProvinceCityComponent() {
         ...
         * @return {?}
         */
        ProvinceCityComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
        Object.defineProperty(ProvinceCityComponent.prototype, "value", {
            get: /**
             * @return {?}
             */ function () {
                return this._value;
         ...
         * @return {?}
         */
        ProvinceCityComponent.prototype.selectedProvince = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        ProvinceCityComponent.prototype.writeValue = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        ProvinceCityComponent.prototype.registerOnChange = /**
         * @param {?} fn
         * @return {?}
         */
            function (fn) {
         ...
         * @return {?}
         */
        ProvinceCityComponent.prototype.registerOnTouched = /**
         * @return {?}
         */
            function () { };
        ProvinceCityComponent.decorators = [
            { type: core$1.Component, args: [{
                        // tslint:disable-next-line:component-selector
                        ...
                        providers: [{
                                ...
                                useExisting: core$1.forwardRef(( /**
                                 * @return {?}
                                 */function () { return ProvinceCityComponent; })),
                                multi: true
                            }],
                        styles: [""]
                    }] }
        ...
        /** @nocollapse */
        ProvinceCityComponent.ctorParameters = function () { return []; };
        ProvinceCityComponent.propDecorators = {
            _value: [{ type: core$1.Input }]
        };
        return ProvinceCityComponent;
    }());
    ...
    var SelectionService = /** @class */ (function () {
        function SelectionService(http$$1) {
            this.http = http$$1;
         ...
         */
            function (api, headers, method) {
                return this.http.request(method, api, { headers: headers }).pipe(operators.map(( /**
                 * @param {?} response
                 * @return {?}
                 */function (response) {
                    return response;
    ...
    var SelectionByApiComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        SelectionByApiComponent.ctorParameters = function () {
            return [
        ...
        SelectionByApiComponent.propDecorators = {
            ...
            lengthToSearch: [{ type: core$1.Input }],
            isClear: [{ type: core$1.Input }],
            method: [{ type: core$1.Input }]
        };
    ...
    var MultiSelectionByApiComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MultiSelectionByApiComponent.ctorParameters = function () {
            return [
                { type: SelectionService },
                { type: core$1.Injector }
            ];
    ...
    var CaptchaComponent = /** @class */ (function () {
         ...
         */
            function () {
                 ...
                 * @return {?}
                 */function () {
                    _this.captchaData = __assign({}, _this.captchaData, { code: _this.random() });
                }), 1);
            };
         ...
         */
            function () {
                this.captchaData = __assign({}, this.captchaData, { code: this.random() });
            };
        ...
        CaptchaComponent.propDecorators = {
            _captchaData: [{ type: core$1.Input }],
            numberOfChar: [{ type: core$1.Input }],
            type: [{ type: core$1.Input }],
            captchaCorrect: [{ type: core$1.Input }],
            message: [{ type: core$1.Input }]
        };
    ...
    var SingleSelect2Component = /** @class */ (function () {
        ...
        /** @nocollapse */
        SingleSelect2Component.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
    ...
    var CustomSwitchInputComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CustomSwitchInputComponent.ctorParameters = function () {
            return [
                { type: core$1.ElementRef },
                { type: core$1.Renderer }
            ];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FileService$1 = /** @class */ (function () {
        function FileService(http$$1) {
            this.url = '/api/v1/upload';
            this.http = http$$1;
        }
    ...
    var UploadFilesComponent = /** @class */ (function () {
        function UploadFilesComponent(injector, api, element, renderer, http$$1, progress) {
            this.injector = injector;
            this.api = api;
            this.element = element;
            this.renderer = renderer;
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var DraftJsComponent = /** @class */ (function () {
        function DraftJsComponent(el) {
            this.el = el;
        }
        /**
         * @return {?}
         */
        DraftJsComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
            function () {
                /** @type {?} */
        ...
        DirectivesModule.decorators = [
            { type: core$1.NgModule, args: [{
                        imports: [
                            ...
                            ngxDropzoneWrapper.DropzoneModule,
                            calendar.CalendarModule,
                            core.NgProgressModule.withConfig({
                                spinnerPosition: 'right',
                                color: '#f71cff'
                            }),
                            http.NgProgressHttpModule
                        ],
                        exports: [
                        ...
                        providers: [
                            {
                                provide: ngxDropzoneWrapper.DROPZONE_CONFIG,
                                useValue: ɵ0
                            }
                        ],
                        declarations: [
         ...
         */
            function (inputs) {
                 ...
                 */function (input) {
                     ...
                     * @return {?}
                     */function (value) {
                        arrayValidator.push(value.validator);
                    }));
                    group[input.key] = new forms.FormControl(input.value || '', arrayValidator, input.asyncValidators);
                }));
     ...
     */ InputBase = /** @class */ (function () {
        function InputBase(options) {
            ...
            this.asyncValidators = Array.isArray(options.asyncValidators) ? options.asyncValidators : [];
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PhoneCode = /** @class */ (function (_super) {
        __extends(PhoneCode, _super);
        function PhoneCode(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'phonecode';
            return _this;
        }
        return PhoneCode;
    }(InputBase));
    ...
    var TinyMce = /** @class */ (function (_super) {
        ...
        function TinyMce(options) {
            ...
            var _this = _super.call(this, options) || this;
            _this.controlType = 'tinymce';
            _this.type = options['type'] || '';
            _this.height = options['height'] || '300';
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SwitchInput = /** @class */ (function (_super) {
        __extends(SwitchInput, _super);
        function SwitchInput(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'switch-input';
            _this.id = options['id'] || 1;
            _this.isDisabled = options['isDisabled'] || false;
            return _this;
        }
        return SwitchInput;
    }(InputBase));
    ...
    var SelectionByApi = /** @class */ (function (_super) {
        __extends(SelectionByApi, _super);
    ...
    var Select2 = /** @class */ (function (_super) {
        ...
        function Select2(options) {
            ...
            _this.tags = options['tags'] || false;
            _this.placeholder = options['placeholder'] || '';
            _this.isSelectAll = options['isSelectAll'] || false;
            _this.selectBtnText = options['selectBtnText'] || 'Select All';
            _this.clearBtnText = options['clearBtnText'] || 'Clear All';
            return _this;
        }
        return Select2;
    }(InputBase));
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ListCheckBox = /** @class */ (function (_super) {
        __extends(ListCheckBox, _super);
        function ListCheckBox(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'list-checkbox';
            _this.options = [];
            _this.options = options['options'] || [];
            return _this;
        }
    ...
    var ReactiveFormComponent = /** @class */ (function () {
        ...
        ReactiveFormComponent.propDecorators = {
            inputs: [{ type: core$1.Input }],
            onSubmit: [{ type: core$1.Input }],
            submitText: [{ type: core$1.Input }],
            onChangeReactive: [{ type: core$1.Input }],
            keysChange: [{ type: core$1.Input }],
            isReset: [{ type: core$1.Input }],
            resetText: [{ type: core$1.Input }],
            customSubmit: [{ type: core$1.Input }],
            customButton: [{ type: core$1.Input }],
            customeSubmitText: [{ type: core$1.Input }],
            customButtonText: [{ type: core$1.Input }],
            saveValue: [{ type: core$1.Input }],
            captcha: [{ type: core$1.Input }]
        };
     ...
     */
    /** @type {?} */
    var UPLOAD_DIRECTIVE_HEADERS = 'UPLOAD_DIRECTIVE_HEADERS';
    /** @type {?} */
    var UPLOAD_DIRECTIVE_API_URL = 'UPLOAD_DIRECTIVE_API_URL';
    var ɵ0$1 = {
        example: 'example'
    };
    var AngularReactiveFormModule = /** @class */ (function () {
        function AngularReactiveFormModule(injector) {
        ...
        /** @nocollapse */
        AngularReactiveFormModule.ctorParameters = function () {
            return [
                { type: core$1.Injector }
            ];
        };
        return AngularReactiveFormModule;
    }());
     ...
     */
    /** @type {?} */
    var VALIDATOR_REQUIRED = 'required';
    /** @type {?} */
    var VALIDATOR_PATTERN = 'pattern';
    /** @type {?} */
    var VALIDATOR_MINLENGTH = 'minlength';
    /** @type {?} */
    var VALIDATOR_MAXLENGTH = 'maxlength';
    /** @type {?} */
    var UpdateFormValue = ( /**
     * @param {?} inputs
     * @param {?} data
                                ...
                                case 'select2':
                                     ...
                                     */function (item) {
                                        ...
                                        try {
                                            ...
                                            try {
                                                if (value_4_1 && !value_4_1.done && (_a = value_4.return))
                                                    _a.call(value_4);
                                            }
                                            finally {
                                                if (e_4)
    ...
    var ValidatorService = /** @class */ (function () {
        function ValidatorService() {
            this.http = AppInjector.get(http$1.HttpClient);
        }
        /**
         * @param {?} api
         * @param {?} headers
         * @return {?}
         */
        ValidatorService.prototype.apiService = /**
         * @param {?} api
         * @param {?} headers
         * @return {?}
         */
            function (api, headers) {
                return this.http.get(api, { headers: headers }).pipe(operators.tap(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) { })), operators.catchError(( /**
                 * @param {?} error
                 * @return {?}
                 */function (error) {
                    throw error;
    ...
    var Validators = /** @class */ (function () {
         ...
         * @return {?}
         */
        Validators.prototype.isEqualValidator = /**
         * @param {?} matchValue
         * @return {?}
         */
            function (matchValue) {
                 ...
                 */function (control) {
                    ...
                    if (value) {
                        /** @type {?} */
                        var compareValue = control.root.get(matchValue).value;
         ...
         * @return {?}
         */
        Validators.prototype.isDifferentValidator = /**
         * @param {?} matchValue
         * @return {?}
         */
            function (matchValue) {
         ...
         * @return {?}
         */
        Validators.prototype.isExistValidator = /**
         * @param {?} url
         * @param {?} message
         * @return {?}
         */
            function (url, message) {
                 ...
                 */function (control) {
                    /** @type {?} */
                    var api = new ValidatorService();
                    /** @type {?} */
                    var value = control.value;
                    /** @type {?} */
                    var UPLOAD_DIRECTIVE_API_URL = AppInjector.get('UPLOAD_DIRECTIVE_API_URL');
                    /** @type {?} */
                    var UPLOAD_DIRECTIVE_HEADERS = AppInjector.get('UPLOAD_DIRECTIVE_HEADERS');
                    return new Promise(( /**
                     * @param {?} resolve
                     * @param {?} reject
                     * @return {?}
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!value)
                                            return [3 /*break*/, 2];
                                        return [4 /*yield*/, api.apiService(UPLOAD_DIRECTIVE_API_URL + url + value, UPLOAD_DIRECTIVE_HEADERS).toPromise()];
                                    case 1:
                                        result = _a.sent();
        ...
        /** @nocollapse */
        Validators.ctorParameters = function () { return []; };
        return Validators;
    }());
    /** @type {?} */
    var DefaultValidators = new Validators();

    /**
     * @fileoverview added by tsickle
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var CustomDropdown = /** @class */ (function (_super) {
        __extends(CustomDropdown, _super);
        function CustomDropdown(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'custom_dropdown';
            _this.options = [];
            _this.options = options['options'] || [];
            return _this;
        }
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var TextBoxMask = /** @class */ (function (_super) {
        __extends(TextBoxMask, _super);
        // example Date:  [/\d/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/]
        function TextBoxMask(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'textbox-mask';
            _this.mask = [];
            _this.mask = options['mask'] || [];
            _this.valueWithCharacter = options['valueWithCharacter'] || false;
            _this.guide = options['guide'] || false;
            _this.placeholder = options['placeholder'] || '';
            return _this;
        }
        return TextBoxMask;
    ...
    var CustomCheckBox = /** @class */ (function (_super) {
        ...
        function CustomCheckBox(options) {
            ...
            var _this = _super.call(this, options) || this;
            _this.controlType = 'custom_checkbox';
    ...
    var Captcha = /** @class */ (function (_super) {
        ...
        function Captcha(options) {
            ...
            var _this = _super.call(this, options) || this;
            _this.controlType = 'captcha';
            _this.numberOfChar = options['numberOfChar'] || 4;
            _this.type = options['type'] || null;
            _this.message = options['message'] || 'Captcha not found';
            return _this;
        }
        return Captcha;
    }(InputBase));
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var SingleSelect2 = /** @class */ (function (_super) {
        __extends(SingleSelect2, _super);
        function SingleSelect2(options) {
            if (options === void 0) {
                options = {};
            }
            var _this = _super.call(this, options) || this;
            _this.controlType = 'single-select2';
            _this.options = [];
            _this.id = options['id'] || 1;
            _this.options = options['options'] || [];
            _this.placeholder = options['placeholder'] || '';
    ...
    exports.SelectionByApi = SelectionByApi;
    exports.Block = Block;
    exports.Captcha = Captcha;
    exports.UPLOAD_DIRECTIVE_HEADERS = UPLOAD_DIRECTIVE_HEADERS;
    exports.UPLOAD_DIRECTIVE_API_URL = UPLOAD_DIRECTIVE_API_URL;
    exports.SingleSelect2 = SingleSelect2;
    exports.SwitchInput = SwitchInput;
    exports.UploadFileV2 = UploadFileV2;
    exports.AngularReactiveFormComponent = AngularReactiveFormComponent;
    exports.AngularReactiveFormModule = AngularReactiveFormModule;
    exports.VALIDATOR_REQUIRED = VALIDATOR_REQUIRED;
    exports.VALIDATOR_PATTERN = VALIDATOR_PATTERN;
    ...
    exports.UpdateInputsValue = UpdateInputsValue;
    exports.support = support;
    exports.DefaultValidators = DefaultValidators;
    exports.ɵx = DynamicInputComponent;
    exports.ɵv = ReactiveFormComponent;
    exports.ɵp = CaptchaComponent;
    exports.ɵi = CustomCheckboxComponent;
    exports.ɵf = CustomDateTimePickerComponent;
    exports.ɵh = CustomSelect2Component;
    exports.ɵb = CustomSelectionComponent;
    exports.ɵr = CustomSwitchInputComponent;
    exports.ɵa = DirectivesModule;
    exports.ɵu = DraftJsComponent;
    exports.ɵe = CustomDropzoneComponent;
    exports.ɵc = MaskInputComponent;
    exports.ɵo = MultiSelectionByApiComponent;
    exports.ɵd = MutipleCheckboxComponent;
    exports.ɵg = PhoneInputComponent;
    exports.ɵl = ProvinceCityComponent;
    exports.ɵn = SelectionService;
    exports.ɵm = SelectionByApiComponent;
    exports.ɵq = SingleSelect2Component;
    exports.ɵt = FileService$1;
    exports.ɵs = UploadFilesComponent;
    exports.ɵk = FileService;
    exports.ɵj = UploadImagesComponent;
    exports.ɵw = FormControlService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=angular-reactive-form.umd.js.map