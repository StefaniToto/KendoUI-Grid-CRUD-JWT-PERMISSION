 ...
 */
class AngularReactiveFormComponent {
    constructor() { }
    /**
     * @return {?}
     */
...
/** @nocollapse */
AngularReactiveFormComponent.ctorParameters = () => [];
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MutipleCheckboxComponent {
    /**
     * @param {?} element
     * @param {?} renderer
     */
    ...
    ngAfterViewInit() {
         ...
         */
        () => {
            if (this.options !== null && this.options !== undefined && !isEmpty(this.options)) {
                /** @type {?} */
                const $this = this;
...
class UploadImagesComponent {
     ...
     * @param {?} renderer
     */
    constructor(injector, api, element, renderer) {
        this.injector = injector;
        this.api = api;
        this.element = element;
        this.renderer = renderer;
...
/** @type {?} */
const Provinces = ((/** @type {?} */ (Object))).values(json$1);

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ProvinceCityComponent {
    constructor() {
...
/** @nocollapse */
ProvinceCityComponent.ctorParameters = () => [];
...
class SelectionByApiComponent {
    ...
    onKeydown(event) {
        if (event.keyCode === this.KEY_CODE.DOWN_ARROW && this.isShow) {
            ...
            if (this.value) {
                /** @type {?} */
                const current_item = find(this.options, (/**
                 * @param {?} i
                 * @return {?}
                 */
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MultiSelectionByApiComponent {
    /**
     * @param {?} api
     * @param {?} injector
     */
...
class CaptchaComponent {
    ...
    ngAfterViewInit() {
         ...
         */
        () => {
            this.captchaData = Object.assign({}, this.captchaData, { code: this.random() });
        }), 1);
    }
    /**
     * @return {?}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CustomSwitchInputComponent {
    /**
     * @param {?} element
     * @param {?} renderer
     */
...
/** @nocollapse */
CustomSwitchInputComponent.ctorParameters = () => [
    { type: ElementRef },
    { type: Renderer }
];
...
FileService$1.decorators = [
    { type: Injectable }
];
/** @nocollapse */
FileService$1.ctorParameters = () => [
    { type: HttpClient }
];
...
/** @nocollapse */
DraftJsComponent.ctorParameters = () => [
    { type: ElementRef }
];
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class PhoneCode extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class SelectionByApi extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'selection-by-api';
        this.resultTransformer = options['resultTransformer'] || null;
        this.apiUpload = options['apiUpload'] || '';
        this.headers = options['headers'] || null;
        this.fieldName = options['fieldName'] || null;
        this.multiple = options['multiple'] || false;
        this.lengthToSearch = options['lengthToSearch'] || 3;
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class Select2 extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'select2';
        this.options = [];
        this.id = options['id'] || 1;
        this.options = options['options'] || [];
        this.tags = options['tags'] || false;
        this.placeholder = options['placeholder'] || '';
        this.isSelectAll = options['isSelectAll'] || false;
        this.selectBtnText = options['selectBtnText'] || 'Select All';
        this.clearBtnText = options['clearBtnText'] || 'Clear All';
    }
}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ListCheckBox extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'list-checkbox';
        this.options = [];
        this.options = options['options'] || [];
    }
}
...
class ReactiveFormComponent {
    ...
    ngOnChanges(changes) {
        ...
        const groups = [];
        /** @type {?} */
        const grouped = groupBy(this.inputs, 'group');
        // tslint:disable-next-line:forin
 ...
 */
/** @type {?} */
const UPLOAD_DIRECTIVE_HEADERS = 'UPLOAD_DIRECTIVE_HEADERS';
/** @type {?} */
const UPLOAD_DIRECTIVE_API_URL = 'UPLOAD_DIRECTIVE_API_URL';
const ɵ0$1 = {
    example: 'example'
};
class AngularReactiveFormModule {
    /**
     * @param {?} injector
     */
...
/** @type {?} */
const VALIDATOR_MINLENGTH = 'minlength';
/** @type {?} */
const VALIDATOR_MAXLENGTH = 'maxlength';
/** @type {?} */
...
/** @type {?} */
const DefaultValidators = new Validators();

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CustomDropdown extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'custom_dropdown';
        this.options = [];
        this.options = options['options'] || [];
    }
}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class TextBoxMask extends InputBase {
    ...
    constructor(options = {}) {
        super(options);
        this.controlType = 'textbox-mask';
        this.mask = [];
        this.mask = options['mask'] || [];
        this.valueWithCharacter = options['valueWithCharacter'] || false;
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DateTimePicker extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        ...
        this.yearRange = options['yearRange'] || '1995:2050';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CustomCheckBox extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'custom_checkbox';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class UploadFile extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'uploadfile';
        this.id = options['id'] || 1;
        this.accept = options['accept'] || '';
        this.allowMaxSize = options['allowMaxSize'] || 2;
        this.apiUpload = options['apiUpload'] || '';
        this.headers = options['headers'] || {};
        this.uploadPath = options['uploadPath'] || '';
        this.multiple = options['multiple'] || false;
        this.paramName = options['paramName'] || 'files';
        this.resultTransformer = options['resultTransformer'];
    }
}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class Province extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'province';
    }
}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class Block extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'block';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class Captcha extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'captcha';
        this.numberOfChar = options['numberOfChar'] || 4;
        this.type = options['type'] || null;
        this.message = options['message'] || 'Captcha not found';
    }
}
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class SingleSelect2 extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'single-select2';
        this.options = [];
        this.id = options['id'] || 1;
        this.options = options['options'] || [];
        this.placeholder = options['placeholder'] || '';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class UploadFileV2 extends InputBase {
    /**
     * @param {?=} options
     */
    constructor(options = {}) {
        super(options);
        this.controlType = 'uploadfilev2';
        this.id = options['id'] || 1;
        this.accept = options['accept'] || '';
        this.allowMaxSize = options['allowMaxSize'] || 2;
        this.apiUpload = options['apiUpload'] || '';
