...
var TreeListComponent = /** @class */ (function () {
    function TreeListComponent(supportService, wrapper, changeNotification, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, columnResizingService, changeDetectorRef, columnReorderService, columnInfoService, navigationService, sortService, scrollRequestService, expandStateService, optionChanges, selectionService, localization) {
        ...
        this.view = new data_collection_1.ViewCollection(this.viewFieldAccessor.bind(this), this.expandStateService, this.editService, this.selectionService);
        ...
        this.subscriptions.add(this.selectionService.changes.subscribe(function (args) {
            if (utils_1.hasObservers(_this.selectionChange)) {
        ...
        this.subscriptions.add(this.view.resetPage.subscribe(function () {
            if (_this.skip > 0 && utils_1.hasObservers(_this.pageChange)) {
    ...
    Object.defineProperty(TreeListComponent.prototype, "isSelected", {
         ...
         */
        set: function (value) {
            if (typeof value !== 'function' && core_1.isDevMode()) {
    ...
    Object.defineProperty(TreeListComponent.prototype, "isExpanded", {
         ...
         */
        set: function (value) {
            this.expandStateService.isExpanded = value || expand_state_service_1.defaultExpanded;
    ...
    TreeListComponent.prototype.verifySettings = function () {
        if (core_1.isDevMode()) {
            ...
            if (this.columnList.filter(column_group_component_1.isColumnGroupComponent).filter(function (x) { return !x.hasChildren; }).length) {
    ...
    TreeListComponent.prototype.attachDomEventHandlers = function () {
        ...
        this.subscriptions.add(this.domEvents.cellClick.subscribe(function (args) {
            if (utils_1.hasObservers(_this.cellClick) || _this.selectionService.enabled) { // enabled only if isSelect is provided
                _this.ngZone.run(function () {
    ...
    TreeListComponent.prototype.handleColumnResize = function () {
        ...
        this.subscriptions.add(resizes.pipe(operators_1.tap(function (e) {
            if (e.type === 'start') {
        ...
        }), operators_1.filter(function (e) { return e.type === 'start'; }), operators_1.switchMap(function () {
            return resizes.pipe(
            // tslint:disable-next-line: rxjs-no-unsafe-takeuntil
            operators_1.takeUntil(resizes.pipe(operators_1.filter(function (e) { return e.type === 'triggerAutoFit'; }))), operators_1.filter(function (e) { return e.type === 'end'; }));
        }))
