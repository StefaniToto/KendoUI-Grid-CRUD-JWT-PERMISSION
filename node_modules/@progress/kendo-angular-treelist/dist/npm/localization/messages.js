...
var Messages = /** @class */ (function (_super) {
    ...
    Messages.propDecorators = {
        ...
        pagerItemsTotal: [{ type: core_1.Input }],
        ...
        lock: [{ type: core_1.Input }],
        unlock: [{ type: core_1.Input }],
        sortable: [{ type: core_1.Input }],
        sortAscending: [{ type: core_1.Input }],
        sortDescending: [{ type: core_1.Input }],
        sortedAscending: [{ type: core_1.Input }],
        sortedDescending: [{ type: core_1.Input }],
        sortedDefault: [{ type: core_1.Input }],
        columnsApply: [{ type: core_1.Input }],
        columnsReset: [{ type: core_1.Input }]
    };
    return Messages;
