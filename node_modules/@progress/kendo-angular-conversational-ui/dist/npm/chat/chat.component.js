...
var ChatComponent = /** @class */ (function () {
    ...
    ChatComponent.propDecorators = {
        ...
        sendMessage: [{ type: core_1.Output }],
        executeAction: [{ type: core_1.Output }],
        className: [{ type: core_1.HostBinding, args: ['class',] }],
        dirAttr: [{ type: core_1.HostBinding, args: ['attr.dir',] }],
        attachmentTemplate: [{ type: core_1.ContentChild, args: [attachment_template_directive_1.AttachmentTemplateDirective,] }],
        messageTemplate: [{ type: core_1.ContentChild, args: [message_template_directive_1.MessageTemplateDirective,] }],
        messageInput: [{ type: core_1.ViewChild, args: ['messageInput',] }],
        messageList: [{ type: core_1.ViewChild, args: ['messageList',] }]
    };
