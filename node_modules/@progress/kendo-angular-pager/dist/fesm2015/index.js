...
*-------------------------------------------------------------------------------------------*/
import { Input, Component, forwardRef, ChangeDetectionStrategy, ChangeDetectorRef, ViewChild, HostBinding, Directive, TemplateRef, Optional, NgZone, EventEmitter, ElementRef, ContentChild, Output, NgModule } from '@angular/core';
...
PagerPageSizesComponent.propDecorators = {
    dropDownList: [{ type: ViewChild, args: ['dropdownlist', { static: true },] }],
...
PagerInputComponent.propDecorators = {
    numericInput: [{ type: ViewChild, args: [NumericTextBoxComponent, { static: true },] }]
};
