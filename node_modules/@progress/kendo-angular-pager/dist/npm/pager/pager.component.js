...
var PagerComponent = /** @class */ (function () {
    function PagerComponent(pagerContext, element, localization) {
        ...
        this._pageSizeValues = util_1.DEFAULT_PAGE_SIZE_VALUES;
    ...
    Object.defineProperty(PagerComponent.prototype, "pageSizeValues", {
        ...
        set: function (pageSizeValues) {
            this._pageSizeValues = Array.isArray(pageSizeValues) ? pageSizeValues : pageSizeValues ? util_1.DEFAULT_PAGE_SIZE_VALUES : false;
        },
        enumerable: true,
        configurable: true
    });
    ...
    PagerComponent.prototype.ngOnChanges = function (changes) {
        if (kendo_angular_common_1.anyChanged(["pageSize", "skip", "total"], changes, false)) {
    ...
    PagerComponent.propDecorators = {
        resizeSensor: [{ type: core_1.ViewChild, args: [kendo_angular_common_1.ResizeSensorComponent, { static: true },] }],
        template: [{ type: core_1.ContentChild, args: [pager_template_directive_1.PagerTemplateDirective, { static: true },] }],
        total: [{ type: core_1.Input }],
        skip: [{ type: core_1.Input }],
        pageSize: [{ type: core_1.Input }],
        buttonCount: [{ type: core_1.Input }],
        info: [{ type: core_1.Input }],
        type: [{ type: core_1.Input }],
        pageSizeValues: [{ type: core_1.Input }],
        previousNext: [{ type: core_1.Input }],
        pageChange: [{ type: core_1.Output }],
        pageSizeChange: [{ type: core_1.Output }],
        pagerWrapClass: [{ type: core_1.HostBinding, args: ['class.k-pager-wrap',] }],
        pagerClass: [{ type: core_1.HostBinding, args: ['class.k-pager',] }],
