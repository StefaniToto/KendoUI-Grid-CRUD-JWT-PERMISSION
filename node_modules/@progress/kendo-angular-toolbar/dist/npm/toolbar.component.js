...
var ToolBarComponent = /** @class */ (function () {
    ...
    ToolBarComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.overflow) {
            this.resizeSubscription = this.resizeSensor.resize.pipe(operators_2.filter(function () { return _this.overflow; })).subscribe(function () {
                _this.onResize();
            });
    ...
    ToolBarComponent.propDecorators = {
        ...
        renderedTools: [{ type: core_1.ViewChildren, args: ['toolbarRenderer',] }],
        overflowRenderedTools: [{ type: core_1.ViewChildren, args: ['overflowRenderer',] }],
