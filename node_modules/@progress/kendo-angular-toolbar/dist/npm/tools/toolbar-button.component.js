...
var ToolBarButtonComponent = /** @class */ (function (_super) {
    ...
    ToolBarButtonComponent.propDecorators = {
        ...
        toolbarButtonElement: [{ type: core_1.ViewChild, args: ['toolbarButton', { read: core_1.ElementRef },] }],
        overflowButtonElement: [{ type: core_1.ViewChild, args: ['overflowButton', { read: core_1.ElementRef },] }]
    };
