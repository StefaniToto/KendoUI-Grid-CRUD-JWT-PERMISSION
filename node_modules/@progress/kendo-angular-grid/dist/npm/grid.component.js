...
var GridComponent = /** @class */ (function () {
    ...
    GridComponent.prototype.editRow = function (rowIndex, group, options) {
        ...
        if (utils_1.isPresent(options) && options.skipFocus) {
            return;
        }
    ...
    GridComponent.prototype.handleColumnResize = function () {
        ...
        this.columnResizingSubscription = resizes.pipe(operators_1.tap(function (e) {
            if (e.type === 'start') {
    ...
    GridComponent.prototype.navigationMetadata = function () {
        ...
        return new navigation_metadata_1.NavigationMetadata(dataRows, headerRows, isVirtual, this.showPager, utils_1.isPresent(this.detailTemplate), this.wrapper, this.virtualColumns, this.columnsContainer);
    };
    ...
    GridComponent.prototype.toggleDetailRowLegacy = function (index, expand) {
        ...
        if (core_1.isDevMode() && hasCallback) {
    ...
    GridComponent.propDecorators = {
        ...
        isDetailExpanded: [{ type: core_1.Input }]
    };
