...
*-------------------------------------------------------------------------------------------*/
import { Injectable, NgZone, Directive, Inject, forwardRef, ElementRef, Renderer2, Input, HostBinding, TemplateRef, EventEmitter, Component, ChangeDetectorRef, ContentChildren, ViewChildren, ViewChild, Output, NgModule } from '@angular/core';
...
SortableComponent.propDecorators = {
    ...
    defaultTemplateRef: [{ type: ContentChildren, args: [TemplateRef, { descendants: false },] }],
    itemTemplateDirectiveRef: [{ type: ContentChildren, args: [ItemTemplateDirective, { read: TemplateRef, descendants: false },] }],
    placeholderTemplateDirectiveRef: [{ type: ContentChildren, args: [PlaceholderTemplateDirective, { read: TemplateRef, descendants: false },] }],
