...
import { merge, fromEvent, BehaviorSubject, Subject, zip, interval } from 'rxjs';
...
var EditorComponent = /** @class */ (function () {
    ...
    Object.defineProperty(EditorComponent.prototype, "disabled", {
        ...
        set: function (value) {
            ...
            if (this._disabled || this._readonly) {
                ...
                this.stateChange.next(this.view ? getToolbarState(this.view.state) : initialToolBarState);
            }
        },
        enumerable: true,
        configurable: true
    ...
    EditorComponent.prototype.initialize = function () {
            ...
            _this.view = new EditorView({ mount: _this.viewMountElement }, {
                ...
                dispatchTransaction: function (tr) {
                    ...
                    if (!(that.disabled || that.readonly)) {
                        ...
                        if (!hasSameMarkup(value_1, that._previousValue, this.state.schema)) {
        ...
        this.subs.add(merge(this.stateChange.pipe(filter(function () { return _this.updateInterval > 0; }), auditTime(this.updateInterval)), this.stateChange.pipe(filter(function () { return _this.updateInterval === 0; }))).subscribe(function () {
