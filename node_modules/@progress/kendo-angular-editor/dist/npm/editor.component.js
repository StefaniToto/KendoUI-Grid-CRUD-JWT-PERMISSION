...
var EditorComponent = /** @class */ (function () {
    ...
    Object.defineProperty(EditorComponent.prototype, "disabled", {
        ...
        set: function (value) {
            ...
            if (this._disabled || this._readonly) {
                ...
                this.stateChange.next(this.view ? editor_toolbar_state_1.getToolbarState(this.view.state) : editor_toolbar_state_1.initialToolBarState);
            }
        },
        enumerable: true,
        configurable: true
    ...
    EditorComponent.prototype.getSource = function () {
        return kendo_editor_common_1.getHtml(this.view.state);
    };
    ...
    EditorComponent.prototype.initialize = function () {
        ...
        var contentNode = kendo_editor_common_1.parseContent((this.value || '').trim(), schema_1.schema);
        if (this.iframe) {
            ...
            [
                styles_1.defaultStyle,
                styles_1.tablesStyles,
                this.dir === 'rtl' ? styles_1.rtlStyles : undefined
        ...
        var state = kendo_editor_common_1.EditorState.create({
            ...
            plugins: [
                ...
                kendo_editor_common_1.keymap(kendo_editor_common_1.buildListKeymap(schema_1.schema)),
                kendo_editor_common_1.keymap(kendo_editor_common_1.buildKeymap(schema_1.schema)),
        ...
        this.ngZone.runOutsideAngular(function () {
            _this.view = new kendo_editor_common_1.EditorView({ mount: _this.viewMountElement }, {
                state: state,
                dispatchTransaction: function (tr) {
                    ...
                    if (!(that.disabled || that.readonly)) {
                        ...
                        // }
                        var value_1 = that.value;
                        if (!kendo_editor_common_1.hasSameMarkup(value_1, that._previousValue, this.state.schema)) {
                            that._previousValue = value_1;
                            that.ngZone.run(function () { return that.valueModified.next(value_1); });
                        }
                    }
                },
        ...
        this.subs.add(rxjs_1.merge(this.stateChange.pipe(operators_1.filter(function () { return _this.updateInterval > 0; }), operators_1.auditTime(this.updateInterval)), this.stateChange.pipe(operators_1.filter(function () { return _this.updateInterval === 0; }))).subscribe(function () {
    ...
    EditorComponent.propDecorators = {
        ...
        iframe: [{ type: core_1.Input }],
        updateInterval: [{ type: core_1.Input }],
        pasteCleanupSettings: [{ type: core_1.Input }],
        ...
        isReadonly: [{ type: core_1.HostBinding, args: ['class.k-readonly',] }],
        isIE: [{ type: core_1.HostBinding, args: ['class.k-ie',] }],
        dir: [{ type: core_1.HostBinding, args: ['attr.dir',] }],
        ariaDisabled: [{ type: core_1.HostBinding, args: ['attr.ariaDisabled',] }],
        userToolBarComponent: [{ type: core_1.ContentChild, args: [kendo_angular_toolbar_1.ToolBarComponent,] }],
        userToolBarElement: [{ type: core_1.ContentChild, args: [kendo_angular_toolbar_1.ToolBarComponent, { read: core_1.ElementRef },] }],
        ...
        defaultToolbarComponent: [{ type: core_1.ViewChild, args: ['defaultToolbar', { read: kendo_angular_toolbar_1.ToolBarComponent },] }]
    };
