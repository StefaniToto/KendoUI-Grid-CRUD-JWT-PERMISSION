...
import { BehaviorSubject, Subject, zip, merge, fromEvent, interval } from 'rxjs';
...
class EditorComponent {
    ...
    initialize() {
        ...
        this.subs.add(merge(this.stateChange.pipe(filter(() => this.updateInterval > 0), auditTime(this.updateInterval)), this.stateChange.pipe(filter(() => this.updateInterval === 0))).subscribe(() => {
