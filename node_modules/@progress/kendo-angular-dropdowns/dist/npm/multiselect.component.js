...
var MultiSelectComponent = /** @class */ (function () {
    ...
    MultiSelectComponent.prototype.setState = function (value) {
        ...
        if (!this.text) {
            if (!(util_1.isPresent(value) && value.length)) {
                this.selectedDataItems = [];
            }
            ...
            if (util_1.isPresent(normalizedValue)) { //if valueNormalizer returns `null` or `undefined` custom value is discarded
                ...
                if (_this.value.indexOf(newValue_1) === -1) {
                    ...
                    if (!customItem && _this.selectionService.isSelected(itemIndex)) {
                        ...
                        _this.selectedDataItems = _this.selectedDataItems.filter(function (item) { return util_1.getter(item, _this.valueField) !== newValue_1; });
                    }
                }
    ...
    MultiSelectComponent.prototype.getSelectedDataItems = function (valueChanges) {
        var _this = this;
        var isBoundToComplexData = util_1.isObjectArray(this.data);
        var prop = this.prop(this.valueField, this.valuePrimitive);
        var currentValue;
        var index;
        ...
        valueChanges.forEachItem(function (value) {
            ...
            else if (util_1.isPresent(value) && !(isBoundToComplexData && _this.valuePrimitive)) { //value is not present in the data
