...
var DropDownListComponent = /** @class */ (function () {
    ...
    DropDownListComponent.prototype.keydown = function (event) {
        ...
        var isHomeEnd = event.keyCode === keys_1.Keys.home || event.keyCode === keys_1.Keys.end;
        ...
        if (!hasSelected || focusedItemNotSelected) {
            if (event.keyCode === keys_1.Keys.down || event.keyCode === keys_1.Keys.right) {
                offset = -1;
            }
            else if (event.keyCode === keys_1.Keys.up || event.keyCode === keys_1.Keys.left) {
                offset = 1;
            }
        }
        var eventData = event;
