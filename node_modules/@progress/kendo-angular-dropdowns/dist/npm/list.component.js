...
var ListComponent = /** @class */ (function () {
    ...
    function ListComponent(dataService, wrapper, selectionService, disabledItemsService, cdr, zone, renderer) {
        ...
        this.selectSubscription = rxjs_1.merge(this.selectionService.onSelect.pipe(operators_1.map(function (args) { return args.indices[0]; })), this.selectionService.onFocus).subscribe(this.scrollToItem.bind(this));
    }
