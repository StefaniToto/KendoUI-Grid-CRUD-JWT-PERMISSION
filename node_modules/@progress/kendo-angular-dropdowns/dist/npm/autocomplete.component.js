...
var AutoCompleteComponent = /** @class */ (function () {
    ...
    AutoCompleteComponent.prototype.subscribeEvents = function () {
        ...
        this.valueChangeSubscription = this.valueChangeSubject.pipe(operators_1.filter(function (candidate) {
    ...
    AutoCompleteComponent.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    providers: [
                        ...
                        {
                            provide: filterable_base_component_1.FilterableDropDownComponentBase, useExisting: core_1.forwardRef(function () { return AutoCompleteComponent; })
                        },
                        {
                            provide: kendo_angular_common_1.KendoInput, useExisting: core_1.forwardRef(function () { return AutoCompleteComponent; })
                        }
                    ],
