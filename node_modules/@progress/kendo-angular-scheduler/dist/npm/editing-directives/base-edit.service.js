...
var setter_1 = require("../common/setter");
var getter_1 = require("../common/getter");
...
var BaseEditService = /** @class */ (function () {
    ...
    function BaseEditService(fields) {
        ...
        this.fields = tslib_1.__assign({}, default_model_fields_1.defaultModelFields, fields);
        this.getId = getter_1.getter(this.fields.id);
        this.getRecurrenceId = getter_1.getter(this.fields.recurrenceId);
        this.getRecurrenceRule = getter_1.getter(this.fields.recurrenceRule);
        this.getRecurrenceExceptions = getter_1.getter(this.fields.recurrenceExceptions);
        this.getStart = getter_1.getter(this.fields.start);
        this.setId = setter_1.setter(this.fields.id);
        this.setRecurrenceRule = setter_1.setter(this.fields.recurrenceRule);
        this.setRecurrenceExceptions = setter_1.setter(this.fields.recurrenceExceptions);
        this.setRecurrenceId = setter_1.setter(this.fields.recurrenceId);
    }
    ...
    BaseEditService.prototype.isRecurring = function (event) {
        return util_1.isRecurring(event, this.fields);
    };
    BaseEditService.prototype.isException = function (event) {
        return util_1.isException(event, this.fields);
    };
    /**
    ...
    BaseEditService.prototype.parseExceptions = function (value) {
        ...
        return value
            .split(';')
            .map(function (ex) { return kendo_angular_intl_1.parseDate(ex, DATE_FORMATS) || undefined; });
    };
    /**
    ...
    BaseEditService.prototype.serializeExceptions = function (exceptions) {
        ...
        return exceptions.map(function (date) {
            return kendo_angular_intl_1.formatDate(kendo_date_math_1.toLocalDate(date), 'yyyyMMddTHHmmss') + 'Z';
        }).join(';');
    };
    ...
    BaseEditService.prototype.buildException = function (item) {
        ...
        util_1.assignField(copy, head, fields.id);
...
exports.BaseEditService = BaseEditService;
