...
function formatEventTime(start, end, isAllDay, localeId) {
    ...
    var endFormat = 't';
    return isAllDay ?
        "" + kendo_angular_intl_1.formatDate(start, startDateFormat, localeId) :
        kendo_angular_intl_1.formatDate(start, startTimeFormat, localeId) + "\u2013" + kendo_angular_intl_1.formatDate(end, endFormat, localeId);
}
