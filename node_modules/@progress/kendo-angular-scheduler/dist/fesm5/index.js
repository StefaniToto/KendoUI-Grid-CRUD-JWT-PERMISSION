...
import { getDate, Day, ZonedDate, toLocalDate, MS_PER_DAY, addDays, firstDayOfMonth, addMonths, firstDayInWeek, timezoneNames } from '@progress/kendo-date-math';
...
var ToolbarNavigationComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ToolbarNavigationComponent.prototype, "calendar", {
     ...
     * @hidden
     */
    ToolbarNavigationComponent.prototype.onBlur = function () {
        this.closePopup();
    };
    ...
    ToolbarViewSelectorComponent.prototype.attachElementEventHandlers = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            var focusOutListener = _this.renderer.listen(element, 'focusout', function (args) {
                var next = args.relatedTarget || document.activeElement;
                var outside = !closest(next, function (node) { return node === element; });
                if (outside) {
...
var AgendaTaskItemComponent = /** @class */ (function () {
    function AgendaTaskItemComponent(localization, localeId) {
        this.localization = localization;
    ...
    Object.defineProperty(AgendaTaskItemComponent.prototype, "eventTitle", {
        get: function () {
            ...
            var time = formatEventTime(start, end, this.item.isAllDay, this.localeId);
...
var AgendaListComponent = /** @class */ (function () {
    ...
    AgendaListComponent.prototype.trackByFn = function (index, _item) {
        return index;
    };
...
var cloneTask = function (eventStart, eventEnd) { return function (task) { return (__assign({}, task, { start: getUTCDate(eventStart), end: task.tail && !task.isAllDay ? eventEnd : addUTCDays(eventStart, 1), startDate: getUTCDate(eventStart) })); }; };
var previousEventEnd = function (start, events) {
    return events.length
        ? events[events.length - 1].end
        : start;
};
var markAsTail = function (isLast) { return function (task) {
    if (isLast) {
        task.tail = true;
    }
    return task;
}; };
var markAsMid = function (task) {
    if (!task.tail) {
        task.mid = true;
    }
    return task;
...
var addTaskPart = function (task, start) {
    return function (tasks, _, day, days) {
        return tasks.concat(compose(markAsMid, cloneTask(previousEventEnd(start, tasks), task.end), markAsTail(day === days.length - 1))(task));
    };
};
...
var AgendaViewInternalComponent = /** @class */ (function () {
    ...
    AgendaViewInternalComponent.prototype.onAction = function (e) {
        ...
        if (e.type === 'next') {
            var next = getDate(addDays(now, this.numberOfDays));
    ...
    AgendaViewInternalComponent.prototype.dateRange = function (date) {
        ...
        var end = getDate(addDays(start, this.numberOfDays));
        var rangeEnd = getDate(addDays(start, this.numberOfDays - 1));
...
var MonthResourceGroup = /** @class */ (function () {
    ...
    MonthResourceGroup.prototype.registerItem = function (component) {
        var range = this.dayRanges[component.rangeIndex];
        range.registerItem(component);
    };
    MonthResourceGroup.prototype.unregisterItem = function (component, id) {
        var range = this.dayRanges[id.rangeIndex];
        if (range) {
...
var MonthSlotService = /** @class */ (function (_super) {
    ...
    MonthSlotService.prototype.forEachItem = function (callback) {
        this.groups.forEach(function (group) {
            group.dayRanges.forEach(function (range) {
                range.items.forEach(function (viewItem) { return callback(viewItem); });
            });
        });
    };
    ...
    MonthSlotService.prototype.invalidate = function () {
        _super.prototype.invalidate.call(this);
        this.forEachItem(function (viewItem) {
            var data = viewItem.item.data;
            Object.keys(data).forEach(function (resourceIndex) {
...
var BaseViewItem = /** @class */ (function () {
    function BaseViewItem(slotService, localization, focusService, element, renderer, localeId) {
    ...
    Object.defineProperty(BaseViewItem.prototype, "eventTitle", {
        get: function () {
            ...
            var time = formatEventTime(startTime, endTime, this.item.isAllDay, this.localeId);
            return time + ", " + this.item.event.title;
        },
        enumerable: true,
        configurable: true
    ...
    BaseViewItem.prototype.ngOnInit = function () {
        ...
        this.subs.add(this.slotService.slotsChange.subscribe(function () {
            ...
            var slotId = { index: _this.index, resourceIndex: _this.resourceIndex, rangeIndex: _this.rangeIndex };
            _this.slotService.unregisterItem(_this, slotId);
    ...
    BaseViewItem.prototype.ngOnChanges = function (changes) {
        ...
        if (anyChanged(['index', 'resourceIndex', 'rangeIndex'], changes)) {
            var resourceIndex = changes.resourceIndex, index = changes.index, rangeIndex = changes.rangeIndex;
            ...
            var previousRangeIndex = rangeIndex ? rangeIndex.previousValue : this.rangeIndex;
            var slotId = {
                index: previousIndex,
...
var MonthViewItemComponent = /** @class */ (function (_super) {
    ...
    function MonthViewItemComponent(slotService, localization, focusService, element, renderer, localeId) {
...
var SlotRange$1 = /** @class */ (function () {
    ...
    SlotRange.prototype.unregisterItem = function (component, id) {
...
var DayTimeResourceGroup = /** @class */ (function () {
    ...
    DayTimeResourceGroup.prototype.unregisterItem = function (component, id) {
...
var EditDialogComponent = /** @class */ (function () {
    ...
    Object.defineProperty(EditDialogComponent.prototype, "autoFocusedElement", {
        get: function () {
...
var RecurrenceService = /** @class */ (function () {
     ...
     * @hidden
     */
    RecurrenceService.prototype.getUniqueId = function () {
...
var RecurrenceEndRuleEditorComponent = /** @class */ (function () {
    ...
    Object.defineProperty(RecurrenceEndRuleEditorComponent.prototype, "userNumericOptions", {
        set: function (options) {
            this.numericOptions = __assign({}, this.numericOptions, options);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RecurrenceEndRuleEditorComponent.prototype, "userDatePickerOptions", {
        set: function (options) {
            this.datePickerOptions = __assign({}, this.datePickerOptions, options);
        },
        enumerable: true,
        configurable: true
    });
...
var RecurrenceMonthlyYearlyEditorComponent = /** @class */ (function () {
    ...
    Object.defineProperty(RecurrenceMonthlyYearlyEditorComponent.prototype, "userNumericOptions", {
        set: function (options) {
            this.numericOptions = __assign({}, this.numericOptions, options);
        },
        enumerable: true,
