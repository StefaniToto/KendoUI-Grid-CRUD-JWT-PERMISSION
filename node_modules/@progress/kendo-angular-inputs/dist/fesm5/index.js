...
*-------------------------------------------------------------------------------------------*/
import { Directive, TemplateRef, Optional, Component, forwardRef, Injector, Renderer2, NgZone, ChangeDetectorRef, ElementRef, Input, Output, ViewChild, ContentChild, HostBinding, EventEmitter, Inject, isDevMode, Injectable, HostListener, ViewChildren, NgModule, ViewContainerRef, ContentChildren } from '@angular/core';
...
var SliderComponent = /** @class */ (function () {
    function SliderComponent(localizationService, injector, renderer, ngZone, changeDetector, hostElement) {
        var _this = this;
...
var InputsModule = /** @class */ (function () {
    ...
    InputsModule.decorators = [
        { type: NgModule, args: [{
                    exports: [TextBoxModule, SliderModule, SwitchModule, NumericTextBoxModule, MaskedTextBoxModule, ColorPickerModule, CheckBoxModule, RadioButtonModule, FormFieldModule],
                    imports: [CommonModule]
                },] },
    ];
    return InputsModule;
