...
*-------------------------------------------------------------------------------------------*/
import { Renderer2, Component, ElementRef, EventEmitter, HostBinding, Input, Output, ViewChild, forwardRef, ContentChild, NgZone, Injector, ChangeDetectorRef } from '@angular/core';
...
import { guid, isDocumentAvailable, hasObservers, Keys, KendoInput, anyChanged } from '@progress/kendo-angular-common';
...
var SliderComponent = /** @class */ (function () {
    ...
    SliderComponent.prototype.sizeComponent = function (animate) {
        ...
        var model = new SliderModel(props, wrapper, track);
        model.resizeTrack();
