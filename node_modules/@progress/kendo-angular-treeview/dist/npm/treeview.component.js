...
var TreeViewComponent = /** @class */ (function () {
    ...
    TreeViewComponent.propDecorators = {
        ...
        assetsContainer: [{ type: core_1.ViewChild, args: ['assetsContainer', { read: core_1.ViewContainerRef, static: true },] }],
        ...
        nodeDragStart: [{ type: core_1.Output }],
        nodeDrag: [{ type: core_1.Output }],
        nodeDrop: [{ type: core_1.Output }],
        nodeDragEnd: [{ type: core_1.Output }],
        addItem: [{ type: core_1.Output }],
        removeItem: [{ type: core_1.Output }],
        ...
        loadMoreButtonTemplate: [{ type: core_1.ContentChild, args: [load_more_button_template_directive_1.LoadMoreButtonTemplateDirective,] }],
